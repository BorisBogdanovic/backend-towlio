        ...
        <tr>
          <td style="background-color: #F9FAFB; height: 94px; padding: 10px;">
            <div style="padding: 32px;">
              <img height="40" src="https://rkxgxhniyyxsdxniswfk.supabase.co/storage/v1/object/public/images/logo.svg" alt="Logo" />
            </div>
          </td>
        </tr>
      </thead>
      <tbody style="background-color: #fff;">
        <tr>
          <td style="padding: 48px 56px;">
           ...
           <div style="border:1px solid #D0D5DD;border-radius: 4px;padding: 16px;max-width: 470px; display: flex;align-items: center; gap: 16pxword-break:break-all;
">
    <img src="https://rkxgxhniyyxsdxniswfk.supabase.co/storage/v1/object/public/images/link.svg" alt="link icon" style="flex-shrink: 0;">
    <a href="{{$url}}" style="color: #1D4ED8; text-decoration: none;overflow-wrap: break-word;word-break: break-word;max-width: 100%;display: inline-block; hover:underline;">
        {{$url}}
    </a>
</div>
